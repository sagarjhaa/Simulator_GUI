...
##
##        poly2 = [10,530,850,530,850,985,10,985]
##        self.canvas.create_polygon(poly2,outline='red',fill='#72b5d4',width=2)
##
##        poly3 = [910,530,1760,530,1760,985,910,985]
##        self.canvas.create_polygon(poly3,outline='red',fill='#72d491',width=2)

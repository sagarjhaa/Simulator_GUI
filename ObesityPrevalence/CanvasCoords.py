...
def roundInt1(a): return int(a+0.5)
def roundInt(a): return a+0.5
...
class CanvasCoords:
    ...
    def set_coordinate_system(self, canvas_width, canvas_height,
        ...
        #print "self.x_range in coord: ", self.x_range
        self.xy_scale = self.canvas_x/self.x_range
    ...
    def physical2canvas2(self,point):
        #print "points in canvas: p2c", point
        #print "self.xy_scale in canvas p2c", self.xy_scale
        #print "in canvas p2c, point[0]", point[0]
        #print "self.x_origin,canvas p2c", self.x_origin
        #print "multiple: ", point[0] * self.xy_scale
        #point[0] = float(point[0])
        #point[1] = float(point[1])
        return (roundInt(self.x_origin + point[0] * self.xy_scale),
                roundInt(self.y_origin - point[1] * self.xy_scale))
...
if __name__ == '__main__':
    ...
    C = CanvasCoords()
    C.set_coordinate_system(400,400, 200,200, 50.0)

...
OVERVIEW:
Parsing of shapefiles. Based on modifications of original code by Luc Anselin
(lucshape5.py)
...
class shapefile(shape):
    ...
    def shpopen(self):
        ...
        #txtDir = os.path.join(currentdir, "latLng.txt")
        #FILE = open(txtDir, "w")
        """

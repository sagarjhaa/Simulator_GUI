...
class ArcViewProject:
    ...
    def __init__(self,shpName):
        projectDir = os.path.dirname(shpName)             #get the directory name
        prefix = os.path.basename(shpName).split(".")[0]  #get the file name
    ...
    def getAllDbfRecords(self):
        self.allRecrds = self.dbfFile.returnAllrecords()
        #print "all records in arcView: ", self.allRecrds
        return self.allRecrds
...
if __name__ == '__main__':
    ...
    class View:
        ...
        def plot(self,width=800,height=800):
            print "come here, arcview plot()"
            map = self.map
